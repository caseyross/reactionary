...
/***/ function(module, exports, __webpack_require__) {
	...
	var Autosuggest, React, WUAttribution, WUConfig, WeatherDisplay, fetchJsonp;
	...
	module.exports = React.createClass({
	  ...
	  updateSuggestions: function(arg) {
	    var value;
	    value = arg.value;
	    return this.getSuggestionsFromAPI(value).then((function(_this) {
	      return function(suggestions) {
	        return _this.setState({
	          suggestions: _this.getCities(suggestions)
	        });
	      };
	    })(this));
	  },
	  getCities: function(suggestions) {
	    return suggestions.filter(function(x) {
	      return x.type === 'city';
	    });
	  },
	  getSuggestionsFromAPI: function(query) {
	    return fetchJsonp('https://autocomplete.wunderground.com/aq?query=' + query, {
	      jsonpCallback: 'cb'
	    }).then(function(res) {
	      if (res.ok) {
	        return res.json();
	  ...
	  chooseSuggestion: function(event, arg) {
	    ...
	    return this.getWeatherFromAPI(suggestion.l).then((function(_this) {
	  ...
	  getWeatherFromAPI: function(location) {
	    var url;
	    url = 'https://api.wunderground.com/api/' + WUConfig.API_KEY + '/almanac/astronomy/conditions/forecast/geolookup' + location + '.json';
	    return fetchJsonp(url).then(function(res) {
	      if (res.ok) {
	        return res.json();
	      } else {
	  ...
	  render: function() {
	    ...
	    }), this.maybeRenderWeather(), React.createElement(WUAttribution, null));
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reducerAndActions = __webpack_require__(191);

	var _reducerAndActions2 = _interopRequireDefault(_reducerAndActions);

	var _Autosuggest = __webpack_require__(192);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsWarning = __webpack_require__(176);
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(global) {var isHostObject = __webpack_require__(173),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var wrapActionCreators = __webpack_require__(185);
	var isPlainObject = __webpack_require__(186);
	var hoistStatics = __webpack_require__(189);
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(global) {var isHostObject = __webpack_require__(187),
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({
	  maybeRenderConditions: function() {
	    var c, conditions;
	    conditions = this.props.weather.current_observation.weather;
	  ...
	  isLocalDaytime: function() {
	    var ref, sunrise, sunset, time;
	    time = this.props.weather.moon_phase.current_time;
	    sunrise = this.props.weather.moon_phase.sunrise;
	    sunset = this.props.weather.moon_phase.sunset;
	    return (sunrise.hour < (ref = parseInt(time.hour, 10)) && ref < sunset.hour) || sunrise.hour === time.hour && sunrise.minute < parseInt(time.minute, 10) || time.hour === sunset.hour && parseInt(time.minute, 10) < sunset.minute;
	  },
	  style: function() {
	    return {
	      color: '#ccc',
	  ...
	  render: function() {
	    return React.createElement("div", {
	      ...
	      "location": this.props.weather.current_observation.display_location
	    }))));
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({
	  ...
	  render: function() {
	    return React.createElement("div", {
	      "style": this.style()
	    }, React.createElement(WUCreditLine, null), React.createElement(WULogo, null));
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({
	  render: function() {
	    return React.createElement("div", null, "Powered by");
	  }
	});
...
/***/ function(module, exports) {
	...
	exports.REFERRAL_LINK = 'https://www.wunderground.com/?apiref=09306794159ce26a';
